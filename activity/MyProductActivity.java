...
public class MyProductActivity extends JFrame implements ActionListener {
	...
	private JButton buttonLogout, buttonBack, buttonCheckSum;
	...
	public MyProductActivity(JFrame prev, Customer customer) {
		...
		buttonCheckSum = new JButton("Check sum");
		buttonCheckSum.setBounds(Theme.GUI_WIDTH-140, 120, Theme.BUTTON_PRIMARY_WIDTH+10,30);
	...
	public void actionPerformed(ActionEvent ae) {
		...
		{
			JOptionPane.showMessageDialog(this, this.customer.CheckSum()+" NIS", "Your product cost you", JOptionPane.INFORMATION_MESSAGE); 
		}
	}
}