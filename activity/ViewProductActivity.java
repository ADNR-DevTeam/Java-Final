...
public class ViewProductActivity extends JFrame implements ActionListener {
	...
	JComboBox<Object> byWhatCB;
	JTable table;
	private JButton buttonLogout, buttonBack, buttonCheck, buttonAddProduct, buttonCheckSum;
	...
	public ViewProductActivity(JFrame prev, Customer customer) {
		...
		byWhatCB = new JComboBox<Object>(new Object[]{"By ID", "By Name"});
	...
	public ViewProductActivity(JFrame prev, Employee employee) {
		...
		buttonAddProduct.setBounds(Theme.GUI_WIDTH-140, 120, Theme.BUTTON_PRIMARY_WIDTH, 30);
		...
		buttonCheckSum = new JButton("Check Sells");
		buttonCheckSum.setBounds(Theme.GUI_WIDTH-140, 160, Theme.BUTTON_PRIMARY_WIDTH+25,30);
		buttonCheckSum.setFont(Theme.FONT_BUTTON);
		buttonCheckSum.setBackground(Theme.BACKGROUND_BUTTON_PRIMARY);
		buttonCheckSum.setForeground(Theme.COLOR_BUTTON_PRIMARY);
		buttonCheckSum.addActionListener(this);
		panel.add(buttonCheckSum);
	...
	public void actionPerformed(ActionEvent ae) {
		...
		else if(ae.getSource().equals(buttonCheckSum))
		{
			JOptionPane.showMessageDialog(this, this.employee.CheckSum()+" NIS", "Total sells", JOptionPane.INFORMATION_MESSAGE); 
		}
	}
