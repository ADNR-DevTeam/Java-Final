...
public class ManageEmployee extends JFrame implements ActionListener {
	...
	private JLabel userIdLabel, employeeNameLabel, phoneNumberLabel, roleLabel, salaryLabel, roleCB;
	...
	public void actionPerformed(ActionEvent ae) {
		if (ae.getSource().equals(buttonEdit)) {
			try {
				employee.updateEmployee(employeeNameTF.getText(),Integer.parseInt(phoneNumberTF.getText()), Double.parseDouble(salaryTF.getText()));
